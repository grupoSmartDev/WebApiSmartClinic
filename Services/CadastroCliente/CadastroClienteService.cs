...
public class CadastroClienteService : ICadastroClienteInterface
{
    ...
    public async Task<ResponseModel<CadastroClienteModel>> Criar(CadastroClienteCreateDto dto)
    {
        ...
        var novaStringConexao = $"Host=62.72.51.219;Port=5432;Database={novoBanco};Username=postgres;Password=Elefante01!;SslMode=Require;Trust Server Certificate=true;";
        //var novaStringConexao = $"Host=localhost;Port=3332;Database={novoBanco};Username=postgres;Password=Elefante01!;";
        var masterConnection = $"Host=62.72.51.219;Port=5432;Database=connections;Username=postgres;Password=Elefante01!;SslMode=Require;Trust Server Certificate=true;";
        //var masterConnection = "Host=localhost;Port=3332;Database=postgres;Username=postgres;Password=Elefante01!;";

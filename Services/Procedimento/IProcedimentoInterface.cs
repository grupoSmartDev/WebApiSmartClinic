...
namespace WebApiSmartClinic.Services.Procedimento
{
    ...
    {
        Task<ResponseModel<List<ProcedimentoModel>>> Listar(int pageNumber = 1, int pageSize = 10, int? codigoFiltro = null, string? nomeFiltro = null, string? descricaoFiltro = null, bool paginar = true);

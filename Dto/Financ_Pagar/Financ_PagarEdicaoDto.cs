...
{
    public class Financ_PagarEdicaoDto
    {
        ...
        public int? FornecedorId { get; set; } // Relacionamento com a tabela de Fornecedor

        [JsonIgnore]
        public CentroCustoModel CentroCusto { get; set; }
        public int? CentroCustoId { get; set; } // Relacionamento com a tabela de CentroCusto

        [JsonIgnore]
        public TipoPagamentoModel TipoPagamento { get; set; }
        public int? TipoPagamentoId { get; set; } // Relacionamento com a tabela de TipoPagamento

        [JsonIgnore]
        public FormaPagamentoModel FormaPagamento { get; set; }
        public int? FormaPagamentoId { get; set; } // Relacionamento com a tabela de FormaPagamento

...
public sealed class Financ_ReceberController : ControllerBase
{
    ...
    public async Task<ActionResult<ResponseModel<List<Financ_ReceberModel>>>> ListarAnalitico([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10, [FromQuery] int? idFiltro = null, [FromQuery] string? descricaoFiltro = null, [FromQuery] int? pacienteIdFiltro = null, [FromQuery] string? dataBaseFiltro = "E",
         [FromQuery] string? ccFiltro = null, [FromQuery] DateTime? dataFiltroInicio = null, [FromQuery] DateTime? dataFiltroFim = null, [FromQuery] string? statusFiltro = null, [FromQuery] bool paginar = true)
    {
        var financ_receber = await _financ_receber.ListarAnalitico(pageNumber, pageSize, idFiltro, descricaoFiltro, pacienteIdFiltro, dataBaseFiltro, ccFiltro, dataFiltroInicio, dataFiltroFim, statusFiltro, paginar);
        return Ok(financ_receber);
    }
